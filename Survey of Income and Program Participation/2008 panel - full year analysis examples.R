...
waves <- 2:11 ; year <- c(2009, 2010, 2011) ; mainwgt <- c('lgtcy1wt','lgtcy2wt','lgtcy3wt') ; yrnum <- 1:3


# make a character vector containing the variables that should be kept from the core file (core keep variables)
core.kv <- 
	c( 
	  'ssuid' , 'epppnum', 'spanel', 'swave', 'srefmon', 'rhcalmn', 'rhcalyr', 'shhadid', 'thearn', 'rhcbrf', 'thunemp', 'eckjt', 'ackjt', 'tckjtint', 'ackjtint','eckoast', 'ackoast', 'tckoint', 'ackoint', 'esvjt', 'asvjt', 'tsvjtint', 'asvjtint','esvoast', 'asvoast', 'tsvoint', 'asvoint', 'emdjt', 'amdjt', 'tmdjtint', 'amdjtint','emdoast', 'amdoast', 'tmdoint', 'amdoint'
	)
...
write.csv(x, file = "SIPP_2008.csv")
